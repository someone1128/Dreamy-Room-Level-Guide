export const about = {
  title: "About Dreamy Room Guide Site",
  subtitle: "Player Community & Game Resources",
  content: {
    mission: {
      title: "Our Mission",
      text: "Our mission is simple: to create the most helpful, accurate, and user-friendly resource for Dreamy Room players. Whether you're stuck on a particularly challenging puzzle or just want to make sure you haven't missed any collectibles, we're here to help.",
    },
    values: {
      title: "Core Values",
      items: [
...
export const privacy = {
  ...
  content: {
    introduction: {
      title: "Introduction",
      text: "This Privacy Policy explains how Dreamy Room collects, uses, and protects your personal information. By using our services, you agree to the terms of this Privacy Policy.",
    },
    dataCollection: {
...
export const termsOfService = {
  ...
  subtitle: "Please read carefully before using this website",
  content: {
    introduction: {
      title: "Introduction",
      text: "Welcome to Dreamy Room Guide Site, a fan-made website dedicated to providing walkthroughs and guides for the Dreamy Room game. By accessing or using our website, you agree to be bound by these Terms of Service.",
    },
    disclaimer: {
      title: "Disclaimer",
      text: "Dreamy Room Guide Site is not affiliated with, endorsed by, or in any way officially connected with the official Dreamy Room game or its developers. All game content, images, and trademarks are property of their respective owners.",
    },
    userConduct: {
      title: "User Conduct",
      text: "When using our website, you agree not to:",
      items: [
        "Use our website in any way that violates any applicable laws",
        ...
        "Use the website for any purpose that is unlawful or prohibited by these Terms of Service",
      ],
    },
    contentPolicy: {
      title: "Content",
    ...
    changesToTerms: {
      ...
      text: "We reserve the right to modify these terms at any time. We will always post the most current version on our website. By continuing to use the website after changes have been made, you agree to be bound by the revised terms.",
    },
    contact: {
      title: "Contact Us",
      text: "If you have any questions about these Terms of Service, please contact us at 3500412641@outlook.com.",
    },
  },
} as const;
